...
<div class="row">
  <div class="col-sm-7">
    <br>
        <div align="center"><img src="{{secure_url('/img/inicio01.png')}}"class="d-block w-300 img-fluid" alt="img" height="500"></div>
  </div>
  <div class="col-sm-4">
  <div align="center"><img src="{{secure_url('/img/Home.png')}}"class="d-block w-300 img-fluid" alt="img" height="500"></div>
  <br>
